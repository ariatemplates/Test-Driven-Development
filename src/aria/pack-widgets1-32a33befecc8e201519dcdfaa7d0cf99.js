...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.AriaSkinInterface",$singleton:!0,$dependencies:["aria.core.JsonValidator","aria.widgets.AriaSkinBeans","aria.widgets.AriaSkinNormalization"],$statics:{WIDGET_SKIN_CLASS_OBJECT_NOT_FOUND:"There is no skin configuration for skin class %1 of widget %2. Skin class std will be used instead. The widget will probably not be displayed correctly."},$prototype:{skinImageProperties:["spriteURL","handleSpriteURLh","proxySpriteURLh","spriteUrl","frameIcon","spriteURLv","spriteURLh"
],normalizeSkin:function(){aria.widgets.AriaSkinNormalization.normalizeSkin(aria.widgets.AriaSkin.skinObject)},getWidgetStates:function(e){var t=aria.core.JsonValidator.getBean("aria.widgets.AriaSkinBeans."+e+"Cfg");return t&&t.$properties.states?t.$properties.states.$properties:null},getSkinObject:function(e,t,n){var r=this.getSkinClasses(e);if(r){t==null&&(t="std");var i=r[t];return i?i:n?null:(this.$logWarn(this.WIDGET_SKIN_CLASS_OBJECT_NOT_FOUND,[t,e]),r.std)}},getSkinClasses:function(e){var t=aria.widgets
.AriaSkin.skinObject[e];if(!t||!t["aria:skinNormalized"]){var n=aria.widgets.AriaSkinNormalization.normalizeWidget(e,t);n&&n!=t&&(t=n,aria.widgets.AriaSkin.skinObject[e]=n)}return t},getGeneral:function(){var e=aria.widgets.AriaSkin.skinObject.general;if(!e||!e["aria:skinNormalized"]){var t=aria.widgets.AriaSkinNormalization.normalizeGeneral(e);e!=t&&(e=t,aria.widgets.AriaSkin.skinObject.general=t)}return e},getIcon:function(e,t){var n=this.getSkinObject("Icon",e,!0),r,i=0,s=0;if(n&&(r=n.content[t])!==undefined
){if(n.biDimensional){var o=r.split("_");i=(n.iconWidth+n.spriteSpacing)*o[0],s=(n.iconHeight+n.spriteSpacing)*o[1]}else n.direction==="x"?i=(n.iconWidth+n.spriteSpacing)*r:n.direction==="y"&&(s=(n.iconHeight+n.spriteSpacing)*r);return{iconLeft:i,iconTop:s,cssClass:"xICN"+e,spriteURL:n.spriteURL,width:n.iconWidth,height:n.iconHeight}}return!1},getSkinName:function(){return aria.widgets.AriaSkin.skinName||"atdefskin"},_extractSkinImages:function(e,t){if(e){var n=this.skinImageProperties;for(var r=0,i=n.length
;r<i;r++){var s=n[r],o=e[s];o&&(t[o]=1)}}},preloadSkinImages:function(e){var t={};e||(e=aria.widgets.AriaSkin.skinObject);if(e)for(var n in e){var r=e[n];if(r&&e.hasOwnProperty(n)&&n!="general")for(var i in r){var s=r[i];if(s&&r.hasOwnProperty(i)){this._extractSkinImages(s,t),this._extractSkinImages(s.frame,t);var o=this.getWidgetStates(n),u=s.states;if(u&&o)for(var a in u)if(o.hasOwnProperty(a)){var f=u[a];f&&(this._extractSkinImages(f,t),this._extractSkinImages(f.frame,t))}}}}var l=[];for(var c in t)t.hasOwnProperty
(c)&&l.push('<span style="background-image:url(',this.getSkinImageFullUrl(c),');">&nbsp;</span>');var h=Aria.$window.document,p=h.createElement("div");return h.body.appendChild(p),p.style.display="none",p.innerHTML=l.join(""),p},getSkinImageFullUrl:function(e){var t=Aria.rootFolderPath;return t?t.charAt(t.length-1)!=="/"&&(t+="/"):t="./",t+this.getGeneral().imagesRoot+e},backgroundMacro:function(e,t,n){var r="",i="";if(t){var s=this.getSkinImageFullUrl(t);r="url("+s+") ",aria.utils.String.endsWith(t,".png")?
i=s.substring(0,s.length-4)+".gif":i=s}var o=["background: ",e," ",r,n,";"];return i&&o.push("_background-image: url(",i,") !important;"),o.join("")}}});
//*******************
...
.getCSSClassNames()+'">'),r=n.getMarkup(),r!=null?e.write(r):e.write("#ERROR IN SUBTEMPLATE#"),e.write("</div>")):this._tplcfg?(e.write('<div style="width:100%; height:100%" class="xLDI"></div>'),this.isDiffered=!0):e.write("<div>#ERROR IN SUBTEMPLATE#</div>")},getDomElt:function(){return this._domElt},__differedComplete:function(){this.isDiffered=!1,this.$raiseEvent("ElementReady")}}});
//*******************
...
:function(e){var t=this._cfg;if(!this._skipContent){e.endSection(),this._div.writeMarkupEnd(e);if(t.resizable&&this._handlesArr){var n=this._handlesArr;for(var r in n)e.write(['<span class="xDialog_resizable xDialog_'+n[r]+'">',"</span>"].join(""))}e.write(['<div class="xDialog_titleBar xDialog_',t.sclass,'_titleBar">'].join(""));if(t.icon){e.write(['<span class="xDialog_icon xDialog_',t.sclass,'_icon">'].join(""));var i=new aria.widgets.Icon({icon:t.icon},this._context,this._lineNumber);e.registerBehavior(i
),i.writeMarkup(e),e.write("</span>")}e.write(['<span class="xDialog_title xDialog_',t.sclass,'_title">',aria.utils.String.escapeHTML(t.title),"</span>"].join(""));if(t.closable){var s=aria.utils.Delegate;this._closeDelegateId=s.add({fn:this._onCloseBtnEvent,scope:this}),e.write(['<span class="xDialog_close xDialog_',t.sclass,'_close" '+s.getMarkup(this._closeDelegateId)+">"].join(""));var o=new aria.widgets.Icon({icon:this._skinObj.closeIcon},this._context,this._lineNumber);e.registerBehavior(o),o.writeMarkup
...
}),this._draggable.$on({dragstart:{fn:this._onDragStart,scope:this},move:{fn:this._onDragMove,scope:this},dragend:{fn:this._onDragEnd,scope:this}})},_createResize:function(){if(this._handlesArr){var e=this._handlesArr,t=0,n=this._domElt,r=aria.utils.Dom.getDomElementChild;for(var i in e){var s=r(n,++t,!1),o=null,u;u=e[i];if(u=="n-resize"||u=="s-resize")o="y";if(u=="w-resize"||u=="e-resize")o="x";this._resizable[u]=new aria.utils.resize.Resize(this._domElt,{handle:s,cursor:u,axis:o}),this._resizable[u].$on({beforeresize
:{fn:this._onResizeStart,scope:this},resize:{fn:this._onResizing,scope:this},resizeend:{fn:this._onResizeEnd,scope:this}})}}},_onDragStart:function(){this.evalCallback(this._cfg.ondragstart)},_onDragMove:function(){!this._cfg.movableProxy&&this._popup&&this._popup.refreshProcessingIndicators()},_onDragEnd:function(){this._popup&&this._popup.refreshProcessingIndicators(),this.setProperty("center",!1),this._calculatePosition(),this.updatePosition(),this.evalCallback(this._cfg.ondragend)},_onResizeStart:function(
){this.evalCallback(this._cfg.beforeresize)},_onResizing:function(){this._popup&&this._popup.refreshProcessingIndicators()},_onResizeEnd:function(){this._calculatePosition(),this._calculateSize(),this.setProperty("center",!1),this._popup&&(this.close(),this.open(),this._popup.refreshProcessingIndicators()),this.evalCallback(this._cfg.resizeend)},_destroyDraggable:function(){this._draggable.$removeListeners({dragstart:{fn:this._onDragStart,scope:this},move:{fn:this._onDragMove,scope:this},dragend:{fn:this._onDragEnd
,scope:this}}),this._draggable.$dispose(),this._draggable=null},_destroyResizable:function(){var e=this._handlesArr;for(var t in e){var n=e[t];this._resizable[n].$dispose(),this._resizable[n]=null}}}});
//*******************
...
,e.keyCode,this.getTextInputField().value,n.start,n.end);r&&r.cancelKeyStroke&&e.preventDefault&&e.preventDefault(!0),this._reactToControllerReport(r,{hasFocus:!0})}},_dom_onkeydown:function(e){this.$DropDownTrait._dom_onkeydown.call(this,e),e.hasStopPropagation||this.$TextInput._dom_onkeydown.call(this,e)},_reactToControllerReport:function(e,t){if(e){var n=e.displayDropDown,r=e.repositionDropDown;this.$TextInput._reactToControllerReport.call(this,e,t),this._cfg&&(n===!0&&!this._dropdownPopup?this._openDropdown
():n===!1&&this._dropdownPopup?this._closeDropdown():r&&this._dropdownPopup&&(this._closeDropdown(),this._openDropdown()))}}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.form.TextInput",$extends:"aria.widgets.form.InputWithFrame",$dependencies:["aria.utils.Function","aria.utils.Data","aria.utils.String","aria.widgets.environment.WidgetSettings"],$css:["aria.widgets.form.TextInputStyle"],$constructor:function(e,t,n,r){this._skinnableClass||(this._skinnableClass="TextInput"),this.$InputWithFrame.constructor.apply(this,arguments),this._minInputMarkupWidth=8,this._defaultInputMarkupWidth=170,this._isPassword=!1,this._isTextarea=!1,this
._valTimer=null,this._keepFocus=!1,this._currentCaretPosition=null,this.controller=r,r&&r.$on({onCheck:this._reactToControllerReportEvent,scope:this}),this._textInputField=null,this._hasFocus=!1,this._customTabIndexProvided=!0,this._isPrefilled=!1,this._simpleHTML=this._skinObj.simpleHTML,this._firstFocus=!0},$destructor:function(){this._textInputField=null,this.controller&&(this.controller.$dispose(),this.controller=null),this.$InputWithFrame.$destructor.call(this)},$statics:{WIDGET_VALUE_IS_WRONG_TYPE:"%1Value %2 is of incorrect type."
},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat("prefill"),e.automaticallyBindedProperties=e.automaticallyBindedProperties.concat("prefillError")},_getTextFieldColor:function(){if(this._simpleHTML)return this._skinObj.states[this._state].color;if(this._isIE7OrLess){var e=this._skinObj.states[this._state];return e.color||e.frame.color}return"inherit"},_inputWithFrameMarkup:function(e){var t=this._cfg,n=this._skinObj,r=this._helpTextSet,i=this._skinObj.helpText,s=this._getTextFieldColor
(),o,u=aria.utils.String,a=["padding:",n.innerPaddingTop,"px ",n.innerPaddingRight,"px ",n.innerPaddingBottom,"px ",n.innerPaddingLeft,"px;position:relative;margin:0;"];this._simpleHTML||a.push("background-color:transparent;border-width:0px;vertical-align:top;");var f=t.invalidText||"",l=this.checkValue({text:f,value:t.value,performCheckOnly:!0});l.report&&(o=l.report,!f&&o.text!=null&&(f=""+o.text),o.$dispose());if(!f){var c=t.prefill&&this.controller&&this.controller.getDisplayTextFromValue?this.controller
.getDisplayTextFromValue(t.prefill):t.prefill;f=c}r&&(this._isIE7OrLess&&this._isPassword?(this._helpTextSet=r=!1,t.helptext=null):s=i.color+(i.italics?";font-style:italic":""));var h=this._isPassword&&!r?"password":"text",p=this._frame.innerWidth-n.innerPaddingLeft-n.innerPaddingRight;p<0&&(p=0);var d="";t.spellCheck!=null&&(d=' spellcheck="'+(t.spellCheck?"true":"false")+'"'),this._isTextarea?e.write(["<textarea",Aria.testMode?' id="'+this._domId+'_textarea"':"",t.disabled?' disabled="disabled"':t.readOnly?' readonly="readonly"'
:"",' type="',h,'" style="',a.join(""),"color:",s,";overflow:auto;resize:none;height: "+this._frame.innerHeight+"px; width:",p,'px;"','value=""',t.maxlength>-1?'maxlength="'+t.maxlength+'" ':" ",t.tabIndex!=null?'tabindex="'+this._calculateTabIndex()+'" ':" ",d,">",u.encodeForQuotedHTMLAttribute(this._helpTextSet?t.helptext:f),"</textarea>"].join("")):e.write(['<input class="xTextInputInput" ',Aria.testMode?' id="'+this._domId+'_input"':"",t.disabled?' disabled="disabled"':t.readOnly?' readonly="readonly"':""
,' type="',h,'" style="',a.join(""),"color:",s,";width:",p,'px;"','value="',u.encodeForQuotedHTMLAttribute(this._helpTextSet?t.helptext:f),'" ',t.maxlength>-1?'maxlength="'+t.maxlength+'" ':" ",t.tabIndex!=null?'tabindex="'+this._calculateTabIndex()+'" ':" ",d,' _ariaInput="1"/>'].join(""))},_initInputMarkup:function(e){this.$InputWithFrame._initInputMarkup.call(this,e),this._textInputField=this._frame.getChild(0),this._reactToChange()},getTextInputField:function(){return!this._textInputField&&!this._initDone&&
this.getDom(),this._textInputField},checkValue:function(e){var t=this.getTextInputField(),n=t?t.value:"",r=null,i=!1;e&&(n=e.text!=null?e.text:n,r=e.value,i=e.performCheckOnly),!i&&this._cfg.directOnBlurValidation&&this.changeProperty("formatError",!1);if(this.controller){var s=this._cfg.formatErrorMessages.length?!0:!1,o;r!=null?o=this.controller.checkValue(r):o=this.controller.checkText(n,s);if(o){o.errorMessages.length?(this.changeProperty("invalidText",n),this._cfg.directOnBlurValidation&&!i&&this.changeProperty
("formatErrorMessages",o.errorMessages)):this._cfg.formatError===!1&&aria.utils.Type.isArray(this._cfg.formatErrorMessages)&&this._cfg.formatErrorMessages.length?(this.changeProperty("invalidText",null),this.changeProperty("formatErrorMessages",[])):o.ok&&this.changeProperty("invalidText",null);if(i)return{isValid:o.ok,report:o};this._reactToControllerReport(o,e);return}return{isValid:!0,report:null}}return{isValid:!0,report:null}},_reactToControllerReportEvent:function(e){this._keepFocus||this._hasFocus?this
._reactToControllerReport(e.report,e.arg):e.report&&e.report.$dispose()},_reactToControllerReport:function(e,t){var n=!1,r=this._cfg;if(e){var i=!0,s=this._hasFocus,o=!1,u=!1;t&&(i=t.resetErrorIfOK!==!1,t.hasFocus!=null&&(s=t.hasFocus),t.stopValueProp&&(o=t.stopValueProp),t.delayedValidation&&(u=t.delayedValidation));if(!u){var a=e.text,f=e.value;a!=null&&!this._helpTextSet&&(this.getTextInputField().value=a,e.caretPosStart!=null&&e.caretPosEnd!=null&&this.setCaretPosition(e.caretPosStart,e.caretPosEnd)),typeof 
f!="undefined"&&!o&&!this._isPropertyEquals("value",f)&&(n=this.setProperty("value",f))}this._cfg&&(e.ok?i&&r.directOnBlurValidation&&this.changeProperty("formatError",!1):e.ok===!1&&(s&&e.matchCorrectValueStart?r.directOnBlurValidation&&this.changeProperty("formatError",!1):r.directOnBlurValidation&&this.changeProperty("formatError",!0),n=this.setProperty("value",undefined))),n&&this._cfg&&(this.changeProperty("error",!1),this.evalCallback(r.onchange)),e.$dispose()}},getCaretPosition:function(){if(!this._hasFocus
)return null;var e=this.getTextInputField(),t={start:0,end:0};if("selectionStart"in e)t.start=e.selectionStart,t.end=e.selectionEnd;else{var n=Aria.$window.document;if(n.selection){var r=n.selection.createRange(),i=r.text.length;r.moveStart("character",-e.value.length);var s=r.text.length;t.start=s-i,t.end=s}}return t},setCaretPosition:function(e,t){if(!this._hasFocus)return;var n=this.getTextInputField();if("selectionStart"in n)n.selectionStart=e,n.selectionEnd=t;else{var r=Aria.$window.document;if(r.selection
){var i=n.createTextRange();i.moveStart("character",e),i.moveEnd("character",-n.value.length+t),i.select()}}},_isPropertyEquals:function(e,t){var n=this.getProperty(e);return n===t},_onBoundPropertyChange:function(e,t,n){if(e==="value"){this.setHelpText(!1),this.setPrefillText(!1,null,!0);var r=this._cfg,i="",s=this.checkValue({performCheckOnly:!0,value:t,text:t==null?"":null});if(!s.isValid){this.$logError(this.WIDGET_VALUE_IS_WRONG_TYPE,[t]),s.report.$dispose();return}this._cfg&&s.report&&s.report.text!=null&&
(this._cfg.directOnBlurValidation&&this.changeProperty("formatError",!1),i=s.report.text),this.getTextInputField().value=i,s.report.$dispose();if(s.report&&s.report.value!=t){var o=s.report.value;this._isPropertyEquals("value",o)||this.setProperty("value",o)}this.setHelpText(!0),(aria.utils.Type.isArray(r.value)&&aria.utils.Array.isEmpty(r.value)||!r.value)&&r.prefill&&r.prefill+""&&this.setPrefillText(!0,r.prefill,!0)}else if(e==="invalidText"){if(t==n)return;var s;this._cfg.value&&(s=this.checkValue({performCheckOnly
:!0,value:this._cfg.value,text:t==null?"":null}));if(!s||!s.isValid){var u=this.getTextInputField();u&&(u.value=t)}s&&s.report&&s.report.$dispose(),t||(this.changeProperty("formatErrorMessages",[]),this.changeProperty("formatError",!1),this.changeProperty("error",!1)),this.setProperty("invalidText",t),this._reactToChange()}else e==="readOnly"||e==="disabled"?(t&&(this._hasFocus=!1),this._cfg[e]=t,this._reactToChange()):e==="mandatory"||e==="formatError"||e==="formatErrorMessages"||e==="error"||e==="errorMessages"?
(this._cfg[e]=t,this._reactToChange()):e=="prefill"?this.setPrefillText(!0,t,!0):e=="prefillError"?t?this.setPrefillText(!0,"",!0):t===!1&&this.setPrefillText(!0,this._cfg.prefill,!0):this.$InputWithFrame._onBoundPropertyChange.apply(this,arguments)},_setState:function(){if(this._cfg.disabled)this._state="disabled";else if(this._cfg.readOnly)this._state="readOnly";else if(this._isPrefilled)this._state="prefill";else{this._cfg.mandatory?this._state="mandatory":this._state="normal";if(this._cfg.formatError||this
._cfg.error)this._state+="Error";if(this._hasFocus||this._keepFocus)this._state+="Focused"}},_updateState:function(){this.$InputWithFrame._updateState.call(this);var e=this._skinObj,t=this._frame.innerWidth-e.innerPaddingLeft-e.innerPaddingRight;t<0&&(t=0),this.getTextInputField().style.width=t+"px",(this._isIE7OrLess||this._simpleHTML)&&!this._helpTextSet&&(this.getTextInputField().style.color=this._getTextFieldColor()),!this._cfg.formatError&&!this._cfg.error&&this._validationPopupHide()},_reactToChange:function(
){var e=this.getTextInputField();e&&(this._updateState(),e.readOnly=this._cfg.readOnly,e.disabled=this._cfg.disabled)},_onvalidate:function(e){this._cfg.onvalidate&&(this.$logWarn(this.WIDGET_PROPERTY_DEPRECATION,["onvalidate"]),this.evalCallback(this._cfg.onvalidate)),e.popup&&this._cfg.error?this._validationPopupShow(this):this._validationPopupHide(this)},_dom_onkeydown:function(e){var t=e.keyCode==e.KC_ENTER;t&&this.checkValue()},_dom_onkeyup:function(e){this._cfg.validationDelay&&(this._valTimer&&aria.core
.Timer.cancelCallback(this._valTimer),this._valTimer=aria.core.Timer.addCallback({fn:this.checkValue,scope:this,args:{delayedValidation:!0},delay:this._cfg.validationDelay}))},_dom_onclick:function(){this._autoselect()},_dom_onfocus:function(e){this._hasFocus=!0;if(!this._keepFocus){var t=this._cfg;if(t.readOnly)return;this.setHelpText(!1),this._isPrefilled&&(this.setPrefillText(!1),this.checkValue({value:t.prefill})),this.checkValue({stopValueProp:!0}),this._cfg&&(t=this._cfg,t.validationEvent==="onFocus"&&
(t.formatError&&t.formatErrorMessages.length||t.error&&t.errorMessages.length)&&this._validationPopupShow(this)),this._updateState()}else{var n=this._currentCaretPosition;this._currentCaretPosition=null,n&&this.setCaretPosition(n.start,n.end)}},_dom_onblur:function(e){if(!this._hasFocus)return;if(!this._keepFocus){var t=this._cfg,n=this._skinObj.helpText;this._hasFocus=!1,this._firstFocus=!0;if(t.readOnly)return;this.checkValue(),t=this._cfg;if(!t)return;t.prefill?this.setPrefillText(!0,t.prefill,!1):this.setHelpText
(!0),t.directOnBlurValidation||this.changeProperty("error",!1),this._updateState();if(t.formatError&&t.validationEvent==="onBlur")this._validationPopupShow(this);else{this._validationPopupHide(this);if(t.directOnBlurValidation){if(t.bind){var r=t.bind.value;if(r){var i=r.inside,s=r.to,o=t.validationGroups;aria.utils.Data.validateValue(i,s,null,o,"onblur");if(!this._cfg)return}}this._onvalidate({popup:!1})}}}else this._currentCaretPosition=this.getCaretPosition(),this._hasFocus=!1},_setAutomaticBindings:function(
e){this.$InputWithFrame._setAutomaticBindings.call(this,e);var t=null,n=null,r;e&&e.bind&&(t=e.bind.value,n=e.bind.prefill),t&&t.inside&&(r=aria.utils.Data._getMeta(t.inside,t.to,!1),e.bind.invalidText||(e.bind.invalidText={inside:r,to:"invalidText"})),n&&n.inside&&(r=aria.utils.Data._getMeta(n.inside,n.to,!1),e.bind.prefillError||(e.bind.prefillError={inside:r,to:"error"}))},_checkCfgConsistency:function(){this.$InputWithFrame._checkCfgConsistency.call(this);var e=this._cfg;e.autoselect==null&&(e.autoselect=
aria.widgets.environment.WidgetSettings.getWidgetSettings().autoselect);var t=e.value;if(e.invalidText){var n=this.checkValue({text:e.invalidText,value:t,performCheckOnly:!0});if(!n.isValid)e.directOnBlurValidation&&this.changeProperty("error",!0),t=e.invalidText,this._helpTextSet=!1,n.report&&n.report.$dispose();else if(n.report){this.changeProperty("error",!1);if(n.report.text==null||n.report.text==="")e.prefill&&e.prefill+""?this._isPrefilled=!0:this._helpTextSet=e.helptext;n.report.$dispose()}this._setState
()}else{if(aria.utils.Type.isArray(t)&&aria.utils.Array.isEmpty(t)||!t)e.prefill&&e.prefill+""?this._isPrefilled=!0:this._helpTextSet=e.helptext;this._isPrefilled&&this._setState()}},setHelpText:function(e){var t=this._cfg;if(!t)return;var n=t.helptext,r=this._skinObj.helpText;if(!n||!this._helpTextSet&&!e||(this._hasFocus||this._keepFocus)&&e)return;var i=this.getTextInputField();if(i.value&&e)return;this._helpTextSet=e;if(!i)return;var s=e?r.color:this._getTextFieldColor(),o=e&&r.italics?"italic":"normal",
u=e?n:"",a=i.style;a.color=s,a.fontStyle=o,i.value=u},setPrefillText:function(e,t,n){var r=this._cfg,i;if(!r)return;var s=this.getTextInputField();if(e){if(!s||s.value&&!this._helpTextSet&&!this._isPrefilled)return;this.setHelpText(!1),t==null?i="":i=this.controller&&this.controller.getDisplayTextFromValue?this.controller.getDisplayTextFromValue(t):t,r.prefillError&&(i=""),i?(this._isPrefilled=!0,s.value=i):(s.value=i,this._isPrefilled=!1,this.setHelpText(!0),this._updateState())}else this._isPrefilled=!1;n&&
(!e||this._state!="prefill")&&this._updateState()},focus:function(e,t){if(this._cfg.disabled)return!1;var n=this.getTextInputField();n.focus(),n.value=n.value,t||this._autoselect()},_autoselect:function(){if(this._firstFocus&&this._cfg.autoselect){this._firstFocus=!1;var e=this.getTextInputField(),t=0,n=e.value.length?e.value.length:0;n&&this.setCaretPosition(t,n)}}}});
//*******************
