...
.call(this)},$statics:{INVALID_MULTISELECT_CONTENT:"Multiselect items should not contain field separator as a value."},$prototype:{setSeparator:function(e){this._separator=e},setFieldDisplay:function(e){this._fieldDisplay=e},setValueDisplay:function(e){this._valueDisplay=e},getSeparator:function(){return this._separator},setListOptions:function(e){this._cacheValues={},this._dataModel.listContent=e},toggleDropdown:function(e,t){var n=this._dataModel,r=n.listContent,i=n.selectedValues;n.selectedIdx=-1,i=this._parseInputString
(r,e),t||aria.utils.Json.equals(i,n.value)||(aria.utils.Json.setValue(n,"selectedValues",i),n.value=i,n.text=this._getDisplayValue(i));var s=new aria.widgets.controllers.reports.DropDownControllerReport;return s.displayDropDown=r.length>0&&!t,s.displayDropDown&&(n.initialInput=e,aria.utils.Json.setValue(n,"listContent",r)),s.text=n.text,s.value=this._getValue(n.text,n.value),i.length||(n.selectedIdx=null),s},_parseInputString:function(e,t){var n=[],r=t.split(this._separator);if(r)for(var i=0,s=r.length;i<s;i++
)for(var o=0,u=e.length;o<u;o++){var a=aria.utils.String.trim(r[i]);e[o].label=e[o].label+"",e[o].value=e[o].value+"",a+="",(e[o].label.toLowerCase()==a.toLowerCase()||e[o].value.toLowerCase()==a.toLowerCase())&&(e[o].label.toLowerCase()==a.toLowerCase()||e[o].value.toLowerCase()==a.toLowerCase())&&!aria.utils.Array.contains(n,e[o].value)&&!e[o].disabled&&n.push(e[o].value)}return n},_getDisplayValue:function(e){var t=this._fieldDisplay,n=this._dataModel.listContent,r=this._fieldDisplay=="value"?"label":"value"
,i=[],s;for(var o=0,u=e.length;o<u;o++){s=e[o];for(var a=0,f=n.length;a<f;a++)n[a].value==s&&i.push(n[a][t]?n[a][t]:n[a][r])}return i.join(this._separator)},checkValue:function(e){var t=new aria.widgets.controllers.reports.DropDownControllerReport,n=this._dataModel,r=this._options;if(e===null)t.ok=!0,n.value=null,n.text="";else{aria.utils.Json.equals(e,n.value)?aria.utils.Json.equals(n.selectedValues,n.value)||(e=n.selectedValues,n.value=e):(aria.utils.Json.setValue(n,"selectedValues",e),n.value=e),t.ok=!0;var i=
this._getDisplayValue(e);n.text=i}return t.ok&&(t.text=n.text,t.value=this._getValue(n.text,n.value)),t},checkText:function(e){var t=this._dataModel,n=t.listContent,r;r=this._parseInputString(n,e),aria.utils.Json.equals(r,t.value)||(aria.utils.Json.setValue(t,"value",r),aria.utils.Json.setValue(t,"text",this._getDisplayValue(r)),aria.utils.Json.setValue(t,"selectedValues",r));var i=new aria.widgets.controllers.reports.DropDownControllerReport;return i.text=t.text,i.value=this._getValue(t.text,t.value),i},checkError
:function(){var e=this._dataModel.listContent,t;for(var n=0,r=e.length;n<r;n++){t=e[n].value+"";if(t.indexOf(this._separator)!=-1){this.$logError(this.INVALID_MULTISELECT_CONTENT);break}}},_checkInputKey:function(e,t,n,r,i){if(aria.DomEvent.KC_ARROW_DOWN===t){var s=this.checkValue(n.split(this._separator));s!=null&&s.$dispose()}var s=new aria.widgets.controllers.reports.DropDownControllerReport;return s.ok=!0,s.cancelKeyStroke=!1,s.displayDropDown=t===aria.DomEvent.KC_ARROW_DOWN,s},_getValue:function(e,t){var n=
this._cacheValues[e];return n?n:(this._cacheValues[e]=t,t)},getDisplayTextFromValue:function(e){return this._getDisplayValue(e)}}});
//*******************
