...
//*******************
Aria.classDefinition({$classpath:"aria.tester.runner.BaseFlow",$extends:"aria.templates.FlowCtrl",$constructor:function(){this.$FlowCtrl.constructor.call(this)},$prototype:{oninitCallback:function(e){this.$FlowCtrl.oninitCallback.call(this,e),this.data.flow=this.flowData},navigate:function(e){var t=this.data.flow,n=t.currentState;if(!this.isTransitionValid(n,e))return this.$logError("FLOW_INVALID_TRANSITION",[e]);var r=aria.utils.Json;r.setValue(t,"currentState",e),this.onStateChange(e),this.$raiseEvent("stateChange")},onStateChange:function(e){},isTransitionValid:function(e,t){var n=this._getTransitionMap();return n[e]&&n[e][t]},_getTransitionMap:function(){var e={},t=function(t,n){e[t]||(e[t]={}),e[t][n]=!0},n=this.flowData,r=n.validTransitions;for(var i=0;i<r.length;i++){var s=r[i];t(s[0],s[1]),s[2]&&t(s[1],s[0])}return e}}});
//*******************
//LOGICAL-PATH:aria/tester/runner/ModuleController.js
//*******************
Aria.classDefinition({$classpath:"aria.tester.runner.ModuleController",$extends:"aria.templates.ModuleCtrl",$dependencies:["aria.tester.runner.datamodel.DataDefinitions","aria.tester.runner.utils.Hash","aria.jsunit.IOViewer","aria.jsunit.AppletWorker","aria.utils.QueryString","aria.jsunit.NewTestRunner","aria.jsunit.JsCoverage","aria.jsunit.TestCommunicator","aria.utils.Callback","aria.tester.runner.utils.TestUtils","aria.tester.runner.appenders.JsonTextDivAppender","aria.jsunit.TestacularReport"],$statics:{DATA_DEFINITION:"aria.tester.runner.datamodel.DataDefinitions"},$implements:["aria.tester.runner.ModuleControllerInterface"],$constructor:function(){this.$ModuleCtrl.constructor.call(this),this._testRunner=null,this._reportAppenders=[new aria.tester.runner.appenders.JsonTextDivAppender],aria.core.JsonValidator.normalize({json:this._data,beanName:this.DATA_DEFINITION+".Root"}),this._readConfigurationParameters()},$prototype:{$hasFlowCtrl:!0,$publicInterfaceName:"aria.tester.runner.ModuleControllerInterface",init:function(e,t){var n=this.getData().campaign,r=n.rootClasspath;Aria.load({classes:[r],oncomplete:{fn:this._onInitLoadCompleted,args:t,scope:this},onerror:{fn:this._onInitLoadError,args:t,scope:this}})},switchView:function(e){var t=aria.tester.runner.utils.Hash;this.json.setValue(this._data.view.configuration,"mini",!this._data.view.configuration.mini),t.setParameter("mini",this._data.view.configuration.mini),this.$callback(e)},_readConfigurationParameters:function(){var e=this.getData().campaign,t=this.getData().view,n=aria.tester.runner.utils.Hash,r=aria.utils.Json;n.getParameter("mini")=="true"&&r.setValue(t.configuration,"mini",!0),n.getParameter("testClasspath")&&r.setValue(e,"rootClasspath",n.getParameter("testClasspath")),(n.getParameter("autorun")=="true"||aria.jsunit.TestacularReport.isTestacularEnabled())&&r.setValue(e,"autorun",!0),n.getParameter("runIsolated")=="true"&&r.setValue(e,"runIsolated",!0)},_onInitLoadCompleted:function(e){this.getData().campaign.loadSuccessful=!0;var t=aria.tester.runner.utils.Hash,n=this.getData().campaign;t.setParameter("testClasspath",n.rootClasspath),this.$callback(e)},_onInitLoadError:function(e){this.$logError("Unable to load test object for classpath : "+this.getData().campaign.rootClasspath),this.getData().campaign.loadSuccessful=!1,this.$callback(e)},preloadSuites:function(e){var t=this.getData().campaign,n=t.rootClasspath;this._testRunner=new aria.jsunit.NewTestRunner,this._testRunner.runIsolated=t.runIsolated,this._testRunner.setRootClasspath(n),this._testRunner.$on({preloadEnd:{fn:this._onPreloadEnd,scope:this,args:e}}),this._testRunner.preload()},_onPreloadEnd:function(e,t){this._testRunner.$on({campaignEnd:this._onCampaignEnd,campaignChange:this._onCampaignChange,scope:this}),this.selectTestSuitesFromHash(),this.updateTests(t)},_onCampaignEnd:function(){this._onCampaignChange(),this.$callback(this._startCampaignCb),this._exportResults()},_exportResults:function(){var e=this._data.campaign,t={errorCount:e.errorCount,tests:[],coverage:{}};for(var n=0;n<e.tests.length;n++){var r=e.tests[n];t.tests.push({classpath:r.classpath,assertCount:r.instance._totalAssertCount,errors:r.instance._errors})}var i=Aria.$window._$jscoverage;typeof i!="undefined"&&(t.coverage=i);for(var s=0;s<this._reportAppenders.length;s++)this._reportAppenders[s].append(t)},_onCampaignChange:function(){this.updateProgress(),this.updateErrorCount(),this.updateTests()},updateProgress:function(){var e=this._testRunner.getFinishedTestsCount(),t=Math.floor(100*(e/this._testRunner.getTestsCount()));aria.utils.Json.setValue(this.getData().campaign,"progress",t)},updateErrorCount:function(){var e=this._testRunner.getFailedTests();aria.utils.Json.setValue(this.getData().campaign,"errorCount",e.length)},updateTests:function(e){aria.utils.Json.setValue(this.getData().campaign,"tests",this._testRunner.getTestCases()),aria.utils.Json.setValue(this.getData().campaign,"testsTree",[this._testRunner._rootTest]),this.storeUnselectedSuitesInHash(),this.$callback(e)},selectTestSuitesFromHash:function(){var e=aria.tester.runner.utils.Hash,t=e.getParameter("unselected"),n=this._testRunner._rootTest;if(!n.$TestSuite)return;var r=n.getAllSubTestSuites();for(var i=0,s=r.length;i<s;i++){var o=r[i].instance,u=o.$classpath;t.indexOf(u)!=-1&&o.setUnselected()}this.updateTests()},storeUnselectedSuitesInHash:function(){var e=aria.tester.runner.utils.TestUtils,t=aria.tester.runner.utils.Hash,n=this._testRunner._rootTest;if(!n.$TestSuite)return;var r=e.getUnselectedSubSuites(n);t.setParameter("unselected",r.join(","))},startCampaign:function(e){var t=[];aria.utils.QueryString.getKeyValue("UITest")!="1"&&(t=["test.aria.widgets.WidgetsUITestSuite"]),this._startCampaignCb=e,aria.jsunit.TestacularReport.attachTestEngine(this._testRunner.getEngine()),this._testRunner.run(this.testObject,t)},pauseCampaign:function(e){this._testRunner.getEngine().pause(e)},resumeCampaign:function(e){this._testRunner.getEngine().resume(e)},reload:function(e){aria.jsunit.TestacularReport.detachTestEngine(this._testRunner.getEngine()),this._testRunner.$dispose();var t=aria.core.Cache.content.classes;for(var n in t){if(!t.hasOwnProperty(n)||n.indexOf("aria.")===0)continue;aria.core.ClassMgr.unloadClass(n,!0)}aria.utils.Json.setValue(this.getData().campaign,"autorun",!0),this.$callback(e)}}});
//*******************
...
//*******************
Aria.interfaceDefinition({$classpath:"aria.tester.runner.ModuleControllerInterface",$extends:"aria.templates.IModuleCtrl",$events:{initSuccessful:"initSuccessful",preloadEnd:"preloadEnd",testEnd:"testEnd",testStateChange:"testStateChange"},$interface:{startCampaign:{$type:"Function",$callbackParam:0},preloadSuites:{$type:"Function",$callbackParam:0},updateTests:{$type:"Function",$callbackParam:0},reload:{$type:"Function",$callbackParam:0},switchView:{$type:"Function",$callbackParam:0},pauseCampaign:{$type:"Function",$callbackParam:0},resumeCampaign:{$type:"Function",$callbackParam:0}}});
//*******************
//LOGICAL-PATH:aria/tester/runner/appenders/JsonTextDivAppender.js
//*******************
Aria.classDefinition({$classpath:"aria.tester.runner.appenders.JsonTextDivAppender",$dependencies:["aria.utils.Dom","aria.utils.Json"],$statics:{REPORT_DIV_ID:"testReport"},$prototype:{_destroyReportDiv:function(){var e=aria.utils.Dom.getElementById(this.REPORT_DIV_ID);e&&e.parentNode.removeChild(e)},_createReportDiv:function(e){var t=aria.utils.Dom.getElementById(this.REPORT_DIV_ID);if(!t){var n=Aria.$window.document;t=n.createElement("DIV"),t.id=this.REPORT_DIV_ID,t.style.display="none",t.innerHTML=e,n.body.appendChild(t)}},append:function(e){this._destroyReportDiv(),this._createReportDiv(aria.utils.Json.convertToJsonString(e))}}});
//*******************
//LOGICAL-PATH:aria/tester/runner/datamodel/DataDefinitions.js
//*******************
Aria.beanDefinitions({$package:"aria.tester.runner.datamodel.DataDefinitions",$description:"Definitions for todo object",$namespaces:{json:"aria.core.JsonTypes"},$beans:{Root:{$type:"json:Object",$description:"Root note for the test runner datamodel",$properties:{campaign:{$type:"Campaign",$description:"Current campaign hosted by the runner",$default:{}},flow:{$type:"json:Object",$description:"Flow data",$properties:{currentState:{$type:"json:String",$description:"currentState of the flow",$default:""}},$default:{}},application:{$type:"json:Object",$description:"Application data : misc information, configuration etc ...",$properties:{configuration:{$type:"json:Object",$description:"",$properties:{coverage:{$type:"json:Boolean",$description:"",$default:!1}},$default:{}}},$default:{}},view:{$type:"json:Object",$description:"View data",$properties:{filter:{$type:"json:Object",$description:"",$properties:{type:{$type:"json:String",$description:"",$default:"all"}},$default:{}},configuration:{$type:"json:Object",$description:"",$properties:{mini:{$type:"json:Boolean",$description:"",$default:!1}},$default:{}},scrollPositions:{$type:"json:Object",$description:"map of scroll positions by id",$default:{}}},$default:{}}},$default:{}},Campaign:{$type:"json:Object",$description:"Wrapper around a test object with reporting information",$properties:{rootClasspath:{$type:"json:String",$description:"Classpath of the root test object to load and use",$default:"MainTestSuite"},currentClasspath:{$type:"json:String",$description:"Classpath of the test currently executed in the scope of this campaign",$default:""},progress:{$type:"json:Integer",$description:"[0,100] Progress percentage.",$default:0},report:{$type:"Report",$description:"",$default:{}},tests:{$type:"json:Array",$description:"",$contentType:{$type:"Test",$description:"",$default:{}},$default:[]},testsTree:{$type:"json:Array",$description:"",$contentType:{$type:"TestWrapper",$description:"",$default:{}},$default:[]},errorCount:{$type:"json:Integer",$description:"All the failures that occured during the current campaign",$default:0}},$default:{}},Report:{$type:"json:Object",$description:"",$properties:{},$default:{}},Test:{$type:"json:Object",$description:"",$properties:{},$default:{}},TestWrapper:{$type:"json:Object",$description:"",$properties:{classpath:{$type:"json:String",$description:"Classpath of the test object",$default:""},instance:{$type:"json:Object",$description:"Instance of the test object",$default:null}},$default:{}},Failure:{$type:"json:Object",$description:"",$properties:{},$default:{}}}});
//*******************
//LOGICAL-PATH:aria/tester/runner/utils/Hash.js
//*******************
(function(){var e={$classpath:"aria.tester.runner.utils.Hash",$singleton:!0,$constructor:function(){this._hashParameters={}},$prototype:{_getHash:function(){return Aria.$window.document.location.hash},_setHash:function(e){Aria.$window.document.location.hash=e},getParameter:function(e){var t=this._getHash();t=t.substring(1);var n=t.split("&");for(var r=0,i=n.length;r<i;r++){var s=n[r];if(s.indexOf("=")!=-1){var o=s.split("=");if(e==o[0])return o[1]}}return""},setParameter:function(e,t){var n=this._getHash(),r=[e,t].join("=");n=n.substring(1)||"";var i=!1,s=n.split("&");for(var o=0,u=s.length;o<u;o++){var a=s[o];if(a.indexOf("=")!=-1){var f=a.split("=");e==f[0]&&(i=!0,s[o]=r)}}i||(s[s.length-1]===""?s[s.length-1]=r:s.push(r)),n="#"+s.join("&"),this._setHash(n)}}};Aria.classDefinition(e)})();
//*******************
//LOGICAL-PATH:aria/tester/runner/utils/TestUtils.js
//*******************
(function(){var e={$classpath:"aria.tester.runner.utils.TestUtils",$singleton:!0,$prototype:{getTestSuiteInfo:function(e){var t=e.instance,n=t.getAllSubTestSuites().length,r=t.getAllSubTestCases().length;return this._formatTestSuiteInfo(n,r)},_formatTestSuiteInfo:function(e,t){var n=e?e+" test suite"+(e>1?"s":""):null,r=t?t+" test case"+(t>1?"s":""):null;return t&&e?[n,r].join(" and "):t||e?[n,r].join(""):"no test available in this suite !"},formatTestCaseName:function(e,t){var n=e.classpath,r=this._formatTestCaseClasspath(n,t);return r},_formatTestCaseClasspath:function(e,t){var n=e.split("."),r=n[n.length-1];return n[n.length-1]="<b>"+r+"</b>",t?"<b>"+r+"</b>":n.join(".")},formatTestErrorsCount:function(e){var t=e.instance.getErrors(),n=t.length;return n+" error"+(n!=1?"s":"")},formatTestSuiteName:function(e){var t=e.$classpath||e.classpath,n=this._formatTestSuiteClasspath(t);return n},_formatTestSuiteClasspath:function(e){var t=e.split(".");return t[t.length-1].replace("TestSuite","")},getSubTestsAsArray:function(e){var t=[],n=e.getSubTests();for(var r=0,i=n.length;r<i;r++){var s=n[r],o=s.instance;if(o&&o.$TestSuite){if(o.isSelected()!==-1&&!o.isSkipped()){var u=this.getSubTestsAsArray(o);o.getSubTests().length!=o.getSubTestSuites().length&&u.length!==0&&t.push(s),t=t.concat(u)}}else t.push(s)}return t},getUnselectedSubSuites:function(e){var t=[],n=e.getSubTestSuites();for(var r=0,i=n.length;r<i;r++){var s=n[r].instance;s.isSelected()==-1?t.push(s.$classpath):s.isSelected()===0&&(t=t.concat(this.getUnselectedSubSuites(s)))}return t}}};Aria.classDefinition(e)})();
//*******************
...
//*******************
Aria.tplScriptDefinition({$classpath:"aria.tester.runner.view.report.ReportScript",$dependencies:["aria.tester.runner.utils.TestUtils"],$destructor:function(){this._backupScrollPosition()},$prototype:{$beforeRefresh:function(){this._backupScrollPosition()},$afterRefresh:function(){var e=this.$getElementById("left"),t=this.data.flow.currentState;if(this.lastFinishedId>10&&t==this.flowCtrl.STATES.ONGOING){var n=e.getScroll();n.scrollTop=23*(this.lastFinishedId-10),e.setScroll(n)}else{var r=this.data.view.scrollPositions.ReportScript_left;r&&e.setScroll(r)}},_backupScrollPosition:function(){var e=this.$getElementById("left");e&&this.$json.setValue(this.data.view.scrollPositions,"ReportScript_left",e.getScroll())},_setLastFinishedId:function(e){this.lastFinishedId=e-1},getTestsArray:function(){var e=aria.tester.runner.utils.TestUtils,t=this.data.campaign.testsTree[0];if(!t)return[];if(!t.$TestSuite)return[{classpath:t.$classpath,instance:t}];var n=e.getSubTestsAsArray(t);return n},getFilteredTestsArray:function(){var e=this.getTestsArray(),t=[];for(var n=0,r=e.length;n<r;n++){var i=e[n];this._isFiltered(i)&&t.push(i)}for(var n=0;n<t.length;n++){var s=t[n],o=t[n+1];if(!o||o.instance&&o.instance.$TestSuite)s.lastInSuite=!1;s.instance&&s.instance.$TestSuite&&(!o||o.instance&&!o.instance.$Assert)&&(t.splice(n,1),n--)}return t},_isFiltered:function(e){var t=e.instance;return this.data.view.filter.type=="all"?!0:t?t.$Assert?this.data.view.filter.type=="errors"&&t.hasError()?!0:this.data.view.filter.type=="warnings"&&t.hasWarning()?!0:!1:!0:!1},getSuiteName:function(e){var t=aria.tester.runner.utils.TestUtils,n=t.formatTestSuiteName(e),r=e.getParentTest();return r&&r.getParentTest()?this.getSuiteName(r)+" | "+n:n},getTestName:function(e){var t=aria.tester.runner.utils.TestUtils;return t.formatTestCaseName(e,this.data.view.configuration.mini)},formatTestErrorsCount:function(e){var t=aria.tester.runner.utils.TestUtils;return t.formatTestErrorsCount(e)},formatTestInfo:function(e){var t=aria.tester.runner.utils.TestUtils,n=e.instance._totalAssertCount,r=n+" asserts",i=e.instance._testsCount,s=i+" tests and ";return"("+s+r+")"},_beforeDisplayReport:function(){this.counter=0,this.currentAssigned=!1},_onErrorTestClick:function(e,t){this.data.view.highlightedTest=t.classpath,this.flowCtrl.navigate(this.flowCtrl.STATES.REPORT)}}});